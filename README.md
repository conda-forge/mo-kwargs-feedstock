...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mo-kwargs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11065&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mo-kwargs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mo-kwargs` can be installed with:

```
conda install mo-kwargs
```

It is possible to list all of the versions of `mo-kwargs` available on your platform with:
